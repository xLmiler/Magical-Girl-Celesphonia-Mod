function damagecul_final(b_mhp, b_hp, a_atk, b_def, a_mat, b_mdf, level, e_enhance, e_swordhance) {
    var damage1 = 0;
    var damage2 = 0;
    var damage = 0;
    ...
    enswordhance += 100;
    if(enswordhance < 1) enswordhance = 1;
    enswordhance /= 100;
    damage1 *= enswordhance;
...
function damagecul_magic_normal(a_atk, b_def, a_mat, b_mdf, level, e_enhance, e_swordhance) {
    var damage1 = 0;
    var damage2 = 0;
    var damage = 0;
    var enhance = $gameVariables.value(1199);
