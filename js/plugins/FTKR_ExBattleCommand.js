...
(function() {
        ...
        if (FTKR.EBC.partyCmdList) {
            FTKR.EBC.partyCmdList.split(',').forEach(function(list){
                ...
                case 'FIGHT':
                    ...
                    break;
                case 'ESCAPE':
                    if(window.eroCommand[8] > 0) this.addCommand('自慰',  'eroSelf');
                    else this.addEscapeCommand();
                    break;
                default:
    ...
    Window_ActorCommand.prototype.addEroCommand = function(cmd) {
        var skill = $dataSkills[968];
        this.addEbcCommand('自慰', 'custom', true, 968, 968);
    };
