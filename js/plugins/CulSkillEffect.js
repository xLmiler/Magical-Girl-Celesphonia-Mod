            ...
            for(var i = 0; i < $gameActors._data[1]._equips.length; i++){
                ...
                if(EquipID >= 1){
                    ...
                    if(EquipNo == Other2 && EquipID == Other1EqID){//同一装備の場合スルー
                        ...
                        $gameVariables._data[4211] = $dataWeapons[EquipID].meta.Skill01
                        $gameVariables._data[4212] = $dataWeapons[EquipID].meta.Skill02
                        $gameVariables._data[4213] = $dataWeapons[EquipID].meta.Skill03
                        $gameVariables._data[4214] = $dataWeapons[EquipID].meta.Skill04
                        $gameVariables._data[4215] = $dataWeapons[EquipID].meta.Skill05
                        $gameVariables._data[4216] = $dataWeapons[EquipID].meta.Skill06
                        $gameVariables._data[4217] = $dataWeapons[EquipID].meta.Skill07
                        $gameVariables._data[4218] = $dataWeapons[EquipID].meta.Skill08
                        $gameVariables._data[4219] = $dataWeapons[EquipID].meta.Skill09
                        $gameVariables._data[4220] = $dataWeapons[EquipID].meta.Skill10
                        AddSkillEffect()
                    }
                    else{
